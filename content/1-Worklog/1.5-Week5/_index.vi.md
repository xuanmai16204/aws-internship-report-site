...
| --- | --- | --- | --- |
| 1 | Em thực hành khai báo tên miền trong Route 53, cấu hình Hosted Zone, tạo các bản ghi DNS và chạy thử cơ chế Failover Routing. | 16/05/2026 | 16/05/2026 |
| 2 | Em cài đặt AWS CLI trên máy tính cá nhân, cấu hình Credentials truy cập và chỉ định Region mặc định. | 17/05/2026 | 17/05/2026 |
| 3 | Em thực hiện cấu hình CloudWatch để theo dõi hiệu năng EC2 và thiết lập cảnh báo Alarm khi CPU vượt ngưỡng. | 19/05/2026 | 19/05/2026 |
| 4 | Em tìm hiểu dịch vụ CloudWatch Logs, thực hiện tạo Log Group và cài đặt Log Agent trên máy chủ. | 21/05/2026 | 21/05/2026 |
